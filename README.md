...
**Содержимое, добавленное в этот репозиторий после коммита `842e5a20e2f708a3b36c5d355fab3f95c05485cb` (`27 April 2026 20:00:00 UTC`), распространяется по двойной лицензии GNU Affero General Public License версии 3.0 и NIGHT CITY INDIVIDUAL CONTRIBUTOR LICENSE AGREEMENT, если не указано иное. См. LICENSE-ICLA-EN.
