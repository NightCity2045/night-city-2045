...
**Содержимое, добавленное в этот репозиторий после коммита `842e5a20e2f708a3b36c5d355fab3f95c05485cb` (`27 April 2026 20:00:00 UTC`), является проприетарным (All Rights Reserved).** Этот репозиторий представляет собой глобальную конверсию игры Space Station 14. Все оригинальные изменения, механики, исходный код и ассеты, созданные специально для проекта Night City 2045, являются проприетарными, и права на них принадлежат исключительно владельцам данного проекта. Строго запрещается использование этой сборки или любых её фрагментов для хостинга сторонних серверов, а также копирование, модификация и распространение нашего уникального кода без прямого письменного разрешения правообладателя.

**Content added to this repository after commit `842e5a20e2f708a3b36c5d355fab3f95c05485cb` (`27 April 2026 20:00:00 UTC`) is proprietary (All Rights Reserved).** This repository is a global conversion of the Space Station 14 game. All original changes, mechanics, source code and assets created specifically for the Night City 2045 project are proprietary, and the rights to them belong exclusively to the owners of this project. Using this assembly or any of its fragments for hosting third-party servers, as well as copying, modifying and distributing our unique code without the direct written permission of the copyright holder is strictly prohibited.
