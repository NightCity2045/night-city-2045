...
job-description-chef = Обеспечьте заведение разнообразными продуктами питания, разделайте трупы животных, чтобы предотвратить утечку аммиака, и поддерживайте оживление в баре.
job-description-chemist = Производите лекарственные препараты для использования врачами, исследуйте сомнительные с этической точки зрения редкие химические вещества и производите боевое оружие, когда на станцию прибудут враги.
job-description-clown = Развлеките съемочную группу с помощью тщательно продуманных фарсовых номеров или ужасных шуток.
...
job-description-ertchaplain = Убедитесь, что последняя воля членов экипажа будет выполнена.
...
job-description-citizen = Живите своей жизнью в городе и помогайте поддерживать район в порядке.
...
job-description-station-ai = Соблюдайте свои законы и служите экипажу.
job-description-visitor = Наслаждайтесь своим отдыхом на станции.
...
job-description-maid = Поддерживайте чистоту и порядок на мостике. Защищайте командный состав, если потребуется. Будьте на связи с центральным командованием и выполняйте их любые приказы.
job-description-militech-chief = Возглавляйте корпоративный отряд, распределяйте закрытые ресурсы и держите приоритеты Militech в фокусе.
job-description-militech-operative-lead = Командуйте полевым отрядом, координируйте реакцию и удерживайте группу в строю.
job-description-militech-operative = Выполняйте операции безопасности, отстаивайте корпоративные интересы и выживайте на улице.
job-description-militech-rigger = Координируйте дроны, держите тактическое оборудование в сети и расширяйте возможности отряда без лишнего риска для людей.
job-description-militech-netrunner = Ломайте вражеские узлы, поддерживайте отряд и держите сеть тихой.
job-description-militech-security-specialist = Обеспечивайте вооруженную защиту сотрудников Militech и охраняемых активов.
job-description-militech-combat-medic = Стабилизируйте раненых под огнем и удерживайте отряд в бою.
job-description-militech-tech = Обслуживайте полевое корпоративное оборудование и держите его в рабочем состоянии под давлением.
job-description-militech-quartermaster = Ведите учет ограниченных запасов, выдавайте снаряжение и держите склад под контролем.
job-description-biotechnica-rigger = Управляйте удалёнными платформами, обслуживайте полевые интерфейсы и держите активы Biotechnica в работе на безопасной дистанции.
