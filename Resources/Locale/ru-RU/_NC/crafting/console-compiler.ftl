...
ent-NCConsoleCompiler-desc = Высокотехнологичный терминал данных, преобразующий цифровые коды в физические чертежи и рецепты. Загрузите сырые данные и вставьте расшифрованный мастер-диск для печати.

# Сырые данные
ent-NCRawDataT1 = Сырые данные (Тир 1)
ent-NCRawDataT1-desc = Низкокачественный осколок данных. При оцифровке даёт 100 очков данных.

ent-NCRawDataT2 = Сырые данные (Тир 2)
ent-NCRawDataT2-desc = Среднекачественный осколок данных. При оцифровке даёт 300 очков данных.

ent-NCRawDataT3 = Сырые данные (Тир 3)
ent-NCRawDataT3-desc = Высококачественный осколок данных. При оцифровке даёт 500 очков данных.

# Сгоревшая болванка
ent-NCRawDataBurned = Сгоревшая болванка
ent-NCRawDataBurned-desc = Использованный и выгоревший диск с данными. Абсолютно бесполезен.
