...
nc-rigger-drone-status-title = Drone status
nc-rigger-drone-status-empty = No linked drones.
nc-rigger-drone-health = Health
nc-rigger-drone-battery = Battery
nc-rigger-drone-status-unknown = unknown
nc-rigger-drone-battery-missing = no cell
